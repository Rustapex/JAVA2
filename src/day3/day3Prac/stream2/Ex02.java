...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		// ArrayList<Acorn> -> List<String> 변환하고 출력하기
		list
		.stream()
		...
		// ArrayList<Acorn> -> List<String> 변환하기 , JAVA 16 이상
		...
		// ArrayList<Acorn> -> List<String> 변환하기 , JAVA 16 미만

		List<String> listName2 = list
		.stream()
		.map(item -> item.getPw())
